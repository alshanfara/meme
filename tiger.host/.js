$(`${`<img style="padding: 2px;margin-left: 23px;width: 90%;margin-top: 35px;pointer-events: none;margin-bottom: 0px;border-radius: 15px;box-shadow: inset 0 0px 0px rgba(0,0,0,0.075), 0 0 8px rgba(0, 0, 0, 1.64)!important;" src="https://www11.0zz0.com/2022/02/13/21/747224763.jpg
" >
\
...
\
<a id="asim2" href="" target="_blank" type="button" style="border-radius: 0px 0px 70px 70px;transform: matrix(1, 0, 0, 1, -256, 126); width: 24%; margin: 2px;" class="btn-asim">اشتراكات</a>
\
<a id="asim3" href="" target="_blank" type="button" style="border-radius: 0px 0px 70px 70px;transform: matrix(1, 0, 0, 1, -256, 126); width: 24%; margin: 2px;" class="btn-asim">قوانين</a>
\
...
.btn-asim {
    ...
    color: #fff!important;
    -webkit-transform: matrix(1,0,0,1,-272,176)!important;
...
.nav-tabs>li.active>a, .nav-tabs>li.active>a:focus, .nav-tabs>li.active>a:hover {
    ...
    box-shadow: 2px 2px 1px 1px #c3b2ad !important;
}
.nav-tabs>li>a {
    background-color: #333333;
...
.label.label.label-primary.mini.fl, div#l1, div#l2, div#l3, ul.nav.nav-tabs.fl li a {
    box-shadow: inset 0 0px 0px rgba(0,0,0,0.075), 0 0 8px rgba(0, 0, 0, 1.64)!important;
    background-color: #091118a8!important;
    background: #888;
...
$('label.ae.fa.label.label-primary.fa-commenting-o').html('<span class="bwall  minix badge border" style="margin-top:-8px;padding:1px 4px;">0</span>');
$(`${''}${'<div class="laith2" style="padding:2px;background-color:white;z-index:1;color:lightslategrey;font-size: small!important;height:22px;">Copyright © 2021 <a title="mobail.host" class="laith" href="https://tigerhost.online/">تايجر هوست</a>. All Rights Reserved</div>'}${''}`).insertAfter($('.lonline'))
